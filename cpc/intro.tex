...
For the whistler wave packet propagate in a one dimensional weakly inhomogeneous magnetic field, Karpman et al. \cite{karpman1974} have proposed reduced Vlasov theory in which a new integral of motion for the resonant particle is obtained, and therefore degenerating the original system.
In our recent work \cite{zheng2023a}, we have proposed a novel theoretical framework that redefines the physics within reference frames moving at local resonant velocities.
